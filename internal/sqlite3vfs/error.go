...
var (
	...
	PermissionsErrorDelete   = sqliteError{1000, "Permissions Error Delete"}
	PermissionsErrorWrite    = sqliteError{1001, "Permissions Error Write"}
	PermissionsErrorTruncate = sqliteError{1001, "Permissions Error Truncate"}
)
