...
throw new Error("Cannot find module \"./lib/helpers\"");
...
__WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */].use(__WEBPACK_IMPORTED_MODULE_2_vue_router___default.a);
...
new __WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */]({
    ...
    methods: {
        loadApps: function () {
            var t = this;
            $.ajax({
                headers: { 'Authorization': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__lib_helpers__["getAuthToken"])() },
                url: '/api/apps',
                dataType: 'json',
                success: apps => t.apps = apps,
                error: __WEBPACK_IMPORTED_MODULE_7__lib_helpers__["defaultErrorHandler"]
            });
        },
    ...
    login: function () {
      ...
      $.ajax({
        ...
        error: function (jqXHR, textStatus, errorThrown) {
          t.loggingin = false;
          t.fn_token = "";
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__lib_helpers__["defaultErrorHandler"])(jqXHR);
        }
      });
    },
    logout: function () {
