  ...
  <div class="signup-container">
    <el-form ref="signupForm" :model="signupForm" :rules="loginRules" class="signup-form" label-position="top">
      <div class="title-container">
        <h3 class="title">~ Concise ~账户注册</h3>
      </div>
      ...
      <el-form-item prop="name" label="姓名">
        <el-input ref="name" v-model="signupForm.name" placeholder="姓名" name="name" type="text" tabindex="2" />
      </el-form-item>

      <el-form-item prop="password" label="密码">
        <el-input ref="password" v-model="signupForm.password" type="password" placeholder="登录密码" name="password"
          tabindex="3" />
      </el-form-item>
