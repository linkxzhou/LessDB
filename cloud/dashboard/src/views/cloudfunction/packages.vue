<template>
  <div class="app-container">
    ...
    <!-- 表格 -->
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="max-width: 600px"
      size="medium">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="form" label-position="left" label-width="140px"
        style="width: 400px; margin-left:50px;">
        <el-form-item label="依赖包名" prop="name">
          <el-input v-model="form.name" :disabled="dialogStatus !== 'create'" placeholder="请输入依赖包名"
            style="width: 400px" />
        </el-form-item>
