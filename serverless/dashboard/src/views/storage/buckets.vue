<template>
  <div class="app-container">
    <div class="filter-container">
      <el-button size="mini" class="filter-item" type="default" icon="el-icon-refresh" @click="getList">
        刷新
      </el-button>
      ...
      <div class="filter-item" style="margin-left: 10px">
        <el-tooltip :content="oss_external_endpoint" placement="top">
          <el-tag type="info">OSS EndPoint
            <i v-clipboard:message="oss_external_endpoint" v-clipboard:success="onCopy" style="margin-left: 3px;"
    ...
    <el-dialog width="800px" title="服务账号" :visible.sync="dialogACFormVisible">
      ...
      <el-form label-position="left" label-width="120px" style="width: 600px; margin-left:50px;">
        ...
        <el-form-item label="Access Key">
          <div>
            {{ access_key }}
            <i v-clipboard:message="access_key" v-clipboard:success="onCopy" style="margin-left: 3px;"
              class="el-icon-document-copy copy-btn" />
          </div>
        </el-form-item>
        ...
        <el-form-item label="Access Secret">
          <div>
            {{ access_secret }}
            <i v-clipboard:message="access_secret" v-clipboard:success="onCopy" style="margin-left: 3px;"
              class="el-icon-document-copy copy-btn" />
          </div>
        </el-form-item>
      </el-form>
