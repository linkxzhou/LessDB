...
func init() {
	...
	RegisterPackage(&Package{
		...
		Deps:       make(map[string]string),
		Interfaces: map[string]reflect.Type{},
		NamedTypes: map[string]reflect.Type{"Context": reflect.TypeOf(func(server.Context) {}).In(0),
		...
		AliasTypes: map[string]reflect.Type{},
		Vars: map[string]reflect.Value{"ErrBadGateway": reflect.ValueOf(server.ErrBadGateway),
		...
		Funcs: map[string]reflect.Value{"New": reflect.ValueOf(server.New),
